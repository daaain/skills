...
- **Name**: Skills
- **GitHub**: [daaain/skills](https://github.com/daaain/skills)
- **Creator**: Daniel Demmel
- **License**: MIT
...
**Valid**: `devcontainer-security`, `email-sequence`, `ab-test-setup`
...
```yaml
description: Guide for setting up secured VS Code dev containers for coding agents. Use when creating or hardening a DevContainer to sandbox Claude Code or other coding agents.
```
...
- `fix: improve clarity in devcontainer-security`
- `docs: update README`
...
1. **Once per session**, on first skill use, check for updates:
   - Fetch `VERSIONS.md` from GitHub: <https://raw.githubusercontent.com/daaain/skills/main/VERSIONS.md>
...
3. **Non-blocking notification** at end of response:
   ...
   Say "update skills" to update automatically, or run `git pull` in your skills folder.
   ```

4. **If user says "update skills"**:
   - Run `git pull` in the skills directory
